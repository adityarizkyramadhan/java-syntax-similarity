...
public class Solution {
    public static void main(String[] args) {
        ...
        while (i < n) {  // Mengganti for loop dengan while loop
            ...
            // Mengganti struktur if-else dengan switch-case
            switch (inputSplit[0].toUpperCase()) {
                case "BELAKANG":
                    if (inputSplit[1].equalsIgnoreCase("LOKOMOTIF")) {
                ...
                case "DEPAN":
                    if (inputSplit[1].equalsIgnoreCase("GERBONG")) {
                        System.out.println("GAGAL");
                        return;
                    }
                    // Menambah gerbong jika perintahnya benar
                ...
                default:
                    // Jika perintah tidak dikenali, tidak ada tindakan.
                    break;
            }
